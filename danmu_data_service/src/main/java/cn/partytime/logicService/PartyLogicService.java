...
public class PartyLogicService {
    ...
    public PartyLogicModel findPartyByLonLat(Double longitude, Double latitude){
        ...
        return findPartyAddressIdAndDate(addressId);
    }

    public PartyLogicModel findPartyAddressIdAndDate(String addressId){
    ...
    public int getPartyDmDensity(String addressId,String partyId){
        ...
        if(object!=null){
            ...
            /*if(StringUtils.isEmpty(partyId)){
                logger.info("当前活动编号==================>{}",partyId);
                redisService.set(key,PartyConst.danmuDensity);
                redisService.expire(key,60*60*24);
                return PartyConst.danmuDensity;
            }else{
                PartyLogicModel partyLogicModel =  findPartyAddressIdAndDate(addressId);
                if(partyLogicModel!=null){
