...
public class MonitorController {
    ...
    public RestResultModel save(String title, String adminUserIds, String content, String key){
    ...
    public RestResultModel update(String id, String title, String adminUserIds, String content, String key){
        RestResultModel restResultModel = new RestResultModel();
