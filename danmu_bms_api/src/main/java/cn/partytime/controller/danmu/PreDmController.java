...
public class PreDmController  extends BaseAdminController {
    ...
    public PageResultModel historyDMList(String msg, Integer pageNumber, Integer pageSize) {
        ...
        if(StringUtils.isEmpty(msg)){
            ...
            danmuModelList = danmuService.findDanmuListByMsgLike(msg,pageNumber,pageSize);
            count = danmuService.findDanmuCountByMsgLike(msg,pageNumber,pageSize);
        }
    ...
    public RestResultModel preDMList(Integer pageNo, Integer pageSize, String dlId, String msg) {
        ...
        if( StringUtils.isEmpty(msg)){
            ...
            //preDanmuModelList  = preDanmuService.findByDanmuLibraryIdAndMsgLike(pageNo, pageSize,dlId,msg);
            //count  = preDanmuService.findByDanmuCountLibraryIdAndMsgLike(pageNo, pageSize,dlId,msg);
