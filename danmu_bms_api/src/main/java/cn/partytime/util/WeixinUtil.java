...
public class WeixinUtil {
    ...
    public static UseSecretInfo getMiniProgramUserOpenIdAndSessionKey( String code) {
        ...
        String requestUrl = wexin_program_openId_sessionKey_Url.replace("APPID",weixinUtil.partyTimeConfig.getMini_appId()).replace("SECRET", weixinUtil.partyTimeConfig.getMini_appSecret()).replace("JSCODE", code);
        log.info("code=>openid url:"+requestUrl);
