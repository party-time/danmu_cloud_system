...
import cn.partytime.rpcService.dataRpcService.impl.PromoServiceHystrix;
...
@FeignClient(value = ServerConst.SERVER_NAME_DATASERVER,fallback = PromoServiceHystrix.class)
